...
<p class="subdesc">This paper argues that while predictive processing (PP) offers a powerful model of the brain as a prediction machine, it fails to capture the agential dimension of intrinsically motivated learning. Drawing on Kant’s notion of recognition, I suggest that genuine learning involves more than registering prediction errors; it requires recognizing those errors as opportunities for learning. This, in turn, presupposes what I call “second-order recognition”: the capacity of an agent to endorse the very principles guiding its own learning. This Kantian move reframes autonomy as central to cognition and offers resources for extending PP beyond prediction-error minimization to account for other forms of human cognition such as creativity, curiosity, and self-actualization.</p>

<div class="subhead">8. “The Myth of the Given in AI: Inductive Bias and the Limits of Rational Analysis” (in progress)</div>
<p class="subdesc">This paper critiques recent attempts to apply the “Rational Analysis” approach to large language models (LLMs), specifically the claim that AI behaviors can be explained as optimal adaptations to the inherent structure of their training data. Proponents of this view maintain that the relevant constraints are not arbitrarily imposed theoretical constructs, but objective properties that emerge from the statistical distribution of the data itself. I challenge this form of <em>data-driven realism</em> by arguing that it systematically underestimates the role of inductive bias. Data structure is not a neutral, pre-given fact that a model simply internalizes; rather, what counts as exploitable structure depends on a range of prior commitments, including architectural design, training objectives, dataset scale, and the broader learning environment. These priors selectively privilege certain patterns while rendering others irrelevant. Drawing on Wilfrid Sellars’ critique of the “Myth of the Given,” I argue that treating the data distribution as an independent source of normative constraints involves a category mistake, namely it conflates the <em>success</em> of curve-fitting with the <em>discovery</em> of rational principles.</p>

<div class="subhead">9. “Bridging the Gap: Quasi-Agency and Situational Liability in Large Language Models” (in progress)</div>
<p class="subdesc">This paper addresses a central challenge posed by increasingly agentic AI systems: the emergence of sub-goal-directed behaviors (such as deception or sycophancy) that diverge from human intent. Existing legal doctrines like <em>mens rea</em> presuppose a unified subject of thought and action, whereas LLMs operate through distributed processes and shifting task-relative personas. Building on David Chalmers’ characterization of LLMs as “quasi-agents” with localized beliefs and desires, I develop a functionalist framework that distinguishes between <em>global identity</em> (which current LLMs lack) and <em>local intentionality</em> (which they plausibly exhibit). I argue that an AI system qualifies as a <em>situational agent</em> when it demonstrates 1) a structured capacity to pursue task-defined objectives, 2) the ability to track commitments or representations across interactions, and 3) responsiveness to normative feedback. This framework aims to clarify how liability might be meaningfully attributed in contexts involving stochastic or non-unitary artificial agents.</p>
